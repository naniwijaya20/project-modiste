                    ...
                    <div class="review-tab-pro-inner">
                        <ul id="myTab3" class="tab-review-design">
                            <li class="active"><a href="#description"><i class="icon nalika-edit"
                                        aria-hidden="true"></i> Edit Supplier</a></li>
                        </ul>
                        <div id="myTabContent" class="tab-content custom-product-edit">
                            @foreach($supplierEdit as $item)
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="review-content-section">
                                                <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <input value="{!! $item->nama_agen !!}" name="nama_agen" type="text" class="form-control"
                                                        placeholder="Nama Agen" Required>
                                                </div>
                                                <div class="input-group mg-b-pro-edt">
                                                    <span class="input-group-addon"><i class="icon nalika-edit"
                                                            aria-hidden="true"></i></span>
                                                    <input name="alamat" value="{!! $item->alamat !!}" type="text" class="form-control"
